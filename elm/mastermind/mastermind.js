...
var _user$project$Utils_ZipperList$toList = function (zipperList) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		zipperList.previous,
		A2(
			...
			{
				ctor: '::',
				_0: zipperList.current,
				_1: {ctor: '[]'}
			},
			zipperList.next));
};
var _user$project$Utils_ZipperList$maybeListToList = function (items) {
	var _p0 = items;
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
...
var _user$project$Utils_ZipperList$hasNext = function (items) {
	return _elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$List$length(items.next),
		0) > 0;
};
var _user$project$Utils_ZipperList$hasPrevious = function (items) {
	return _elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$List$length(items.previous),
		0) > 0;
};
var _user$project$Utils_ZipperList$update = F2(
	function (item, items) {
		return _elm_lang$core$Native_Utils.update(
			items,
			{current: item});
	});
var _user$project$Utils_ZipperList$current = function (items) {
	return items.current;
};
var _user$project$Utils_ZipperList$forward = function (items) {
		...
		if (_p1.ctor === 'Just') {
			return _elm_lang$core$Native_Utils.update(
				items,
				{
					...
					current: _p1._0,
					next: _user$project$Utils_ZipperList$maybeListToList(
...
var _user$project$Utils_ZipperList$add = F2(
	function (item, items) {
		...
		return _user$project$Utils_ZipperList$forward(newItems);
	});
var _user$project$Utils_ZipperList$back = function (items) {
			...
			return _elm_lang$core$Native_Utils.update(
				items,
				{
					previous: _elm_lang$core$List$reverse(
						_user$project$Utils_ZipperList$maybeListToList(
...
var _user$project$Utils_ZipperList$ZipperList = F3(
	function (a, b, c) {
		return {previous: a, current: b, next: c};
	});
var _user$project$Utils_ZipperList$init = F2(
	function (item, items) {
		return A3(
			_user$project$Utils_ZipperList$ZipperList,
			{ctor: '[]'},
			item,
			items);
	});
					...
					_0: _elm_lang$html$Html_Attributes$class(
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								glyph,
								A2(_elm_lang$core$Basics_ops['++'], ' ', style_)))),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {ctor: '[]'}
...
var _user$project$Main$viewGameStateMessage = function (gameState) {
	var _p2 = gameState;
	switch (_p2.ctor) {
		case 'Start':
			return A2(
				_rundis$elm_bootstrap$Bootstrap_Alert$simpleInfo,
				{ctor: '[]'},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Click \'New Game\' to start.'),
					_1: {ctor: '[]'}
				});
		case 'Try':
			return A2(
				_rundis$elm_bootstrap$Bootstrap_Alert$simpleWarning,
				{ctor: '[]'},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Try to break the code.'),
					_1: {ctor: '[]'}
				});
		case 'Win':
			return A2(
		...
		default:
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('You lose!'),
					_1: {ctor: '[]'}
				});
	}
};
var _user$project$Main$toDisplayableHistories = function (history) {
	var idxList = function (_p3) {
		return _elm_lang$core$Array$toIndexedList(
			_elm_lang$core$Array$fromList(_p3));
	}(
		_user$project$Utils_ZipperList$toList(history));
	var curIndex = _elm_lang$core$List$length(history.previous);
	return _elm_lang$core$List$reverse(
		A3(
			_elm_lang$core$List$foldl,
			F2(
				function (_p4, acc) {
					...
					return {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: _p6, _1: _p6 - curIndex},
						_1: acc
					};
				}),
			{ctor: '[]'},
...
var _user$project$Main$toHistoryLines = function (history) {
	var _p7 = _user$project$Main$toDisplayableHistories(history);
	if (_p7.ctor === '[]') {
		return {ctor: '[]'};
	} else {
		if (_p7._1.ctor === '[]') {
			return {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'Start', _1: _p7._0._1},
				_1: {ctor: '[]'}
			};
		} else {
			if ((_p7._1._0.ctor === '_Tuple2') && (_p7._1._1.ctor === '[]')) {
				return {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'Start', _1: _p7._0._1},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'Resume', _1: _p7._1._0._1},
						_1: {ctor: '[]'}
					}
				};
			} else {
				var _p12 = _p7._1;
				var rest_ = function () {
					var _p8 = _elm_lang$core$List$reverse(_p12);
					if (_p8.ctor === '::') {
						return _elm_lang$core$List$reverse(_p8._1);
					} else {
						return {ctor: '[]'};
					}
				}();
				var mid = _elm_lang$core$List$reverse(
					A3(
						_elm_lang$core$List$foldl,
						F2(
							function (_p9, acc) {
						...
						rest_));
				var end = function () {
					var _p11 = _elm_lang$core$List$reverse(_p12);
					if (_p11.ctor === '::') {
						return {ctor: '_Tuple2', _0: 'Resume', _1: _p11._0._1};
					} else {
						return {ctor: '_Tuple2', _0: 'Resume', _1: 0};
					}
				}();
				var start = {ctor: '_Tuple2', _0: 'Start', _1: _p7._0._1};
				return {
					ctor: '::',
					_0: start,
					_1: A2(
...
var _user$project$Main$toColor = function (pegColor) {
	var _p13 = pegColor;
	switch (_p13.ctor) {
		case 'Blue':
			return 'blue';
...
var _user$project$Main$viewCodePeg = function (pegColor) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class(
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$Main$toColor(pegColor),
						' rounded-circle'))),
			_1: {ctor: '[]'}
		},
		{ctor: '[]'});
};
var _user$project$Main$viewCodeToBreak = function (codeToBreak) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('d-flex flex-row'),
					_1: {ctor: '[]'}
				},
				A2(_elm_lang$core$List$map, _user$project$Main$viewCodePeg, codeToBreak)),
			_1: {ctor: '[]'}
		});
};
var _user$project$Main$viewBreakerTry = function (breakerTry) {
	return A2(
		_rundis$elm_bootstrap$Bootstrap_ListGroup$li,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				A2(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$Main$viewCodePeg,
						_user$project$Utils_ZipperList$toList(breakerTry.pegs)),
					{
						ctor: '::',
						_0: _user$project$Main$viewResult(breakerTry.result),
						_1: {ctor: '[]'}
					})),
			_1: {ctor: '[]'}
		});
};
var _user$project$Main$viewBoard = F2(
	function (breakerTries, codeToBreak) {
		return _rundis$elm_bootstrap$Bootstrap_ListGroup$ul(
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(
					_elm_lang$core$List$map,
					_user$project$Main$viewBreakerTry,
					_user$project$Utils_ZipperList$toList(breakerTries)),
				{
					ctor: '::',
					_0: _user$project$Main$viewCodeToBreak(codeToBreak),
					_1: {ctor: '[]'}
				}));
	});
...
var _user$project$Main$checkTry = F2(
	function (breakerTry, codeToBreak) {
		return _elm_lang$core$Maybe$Just(
			_elm_lang$core$Native_Utils.eq(
				_user$project$Utils_ZipperList$toList(breakerTry.pegs),
				codeToBreak));
	});
var _user$project$Main$nbMaxTries = 10;
var _user$project$Main$BreakerTry = F2(
	function (a, b) {
		return {pegs: a, result: b};
	});
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {breakerTries: a, codeToBreak: b, gameState: c, randomSeed: d, history: e};
	});
...
var _user$project$Main$initBreakerTry = {
	pegs: A2(
		_user$project$Utils_ZipperList$init,
		_user$project$Main$Grey,
		A2(_elm_lang$core$List$repeat, 3, _user$project$Main$Grey)),
	result: _elm_lang$core$Maybe$Nothing
};
var _user$project$Main$initBreakerTries = A2(
	_user$project$Utils_ZipperList$init,
	_user$project$Main$initBreakerTry,
	A2(_elm_lang$core$List$repeat, _user$project$Main$nbMaxTries - 1, _user$project$Main$initBreakerTry));
var _user$project$Main$initHistory = A2(
	_user$project$Utils_ZipperList$init,
	_user$project$Main$initBreakerTries,
	{ctor: '[]'});
var _user$project$Main$Green = {ctor: 'Green'};
var _user$project$Main$Blue = {ctor: 'Blue'};
var _user$project$Main$choosableColors = {
	ctor: '::',
...
var _user$project$Main$getColor = function (color_) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$Main$Grey,
		A2(
			...
			color_,
			_elm_lang$core$Array$fromList(_user$project$Main$choosableColors)));
};
var _user$project$Main$randomColor = A2(
	_elm_lang$core$Random$map,
	function (x) {
		return _user$project$Main$getColor(x);
	},
	A2(
		_elm_lang$core$Random$int,
		0,
		_elm_lang$core$List$length(_user$project$Main$choosableColors) - 1));
var _user$project$Main$generateCodeToBreak = function (initSeed) {
	return A3(
		_elm_lang$core$List$foldl,
		F2(
			function (_p15, _p14) {
				var _p16 = _p14;
				var _p17 = A2(_elm_lang$core$Random$step, _user$project$Main$randomColor, _p16._1);
				var res = _p17._0;
				var newSeed = _p17._1;
				return {
					ctor: '_Tuple2',
					_0: {ctor: '::', _0: res, _1: _p16._0},
					_1: newSeed
				};
			}),
		{
...
var _user$project$Main$Try = {ctor: 'Try'};
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p18 = msg;
		switch (_p18.ctor) {
			case 'NewGame':
				var _p19 = _user$project$Main$generateCodeToBreak(model.randomSeed);
				var newCode = _p19._0;
				var newSeed = _p19._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{breakerTries: _user$project$Main$initBreakerTries, codeToBreak: newCode, gameState: _user$project$Main$Try, randomSeed: newSeed, history: _user$project$Main$initHistory}),
					{ctor: '[]'});
			case 'ChooseColor':
				var breakerTry = _user$project$Utils_ZipperList$current(model.breakerTries);
				var newBreakerTry = _elm_lang$core$Native_Utils.update(
					breakerTry,
					{
						pegs: function (_p20) {
							return A2(
								_user$project$Utils_ZipperList$update,
								_p18._0,
								function (_) {
									return _.pegs;
								}(_p20));
				...
				var breakerTries = A2(_user$project$Utils_ZipperList$update, newBreakerTry, model.breakerTries);
				var endGameState = function () {
					var _p22 = {
						ctor: '_Tuple3',
						_0: _user$project$Utils_ZipperList$hasNext(breakerTries),
						_1: function (_p21) {
							return _user$project$Utils_ZipperList$hasNext(
								function (_) {
									return _.pegs;
								}(
									_user$project$Utils_ZipperList$current(_p21)));
						}(breakerTries),
						_2: A2(
							_user$project$Main$checkTry,
							_user$project$Utils_ZipperList$current(breakerTries),
							model.codeToBreak)
					};
					_v11_2:
					do {
						if ((_p22.ctor === '_Tuple3') && (_p22._1 === false)) {
							if (_p22._0 === false) {
								return _user$project$Main$Lose;
							} else {
								if ((_p22._2.ctor === 'Just') && (_p22._2._0 === true)) {
									return _user$project$Main$Win;
								} else {
									break _v11_2;
								}
							}
				...
				var breakerTry_ = _user$project$Utils_ZipperList$current(breakerTries);
				var newBreakerTry_ = function () {
					var _p24 = function (_p23) {
						return _user$project$Utils_ZipperList$hasNext(
							function (_) {
								return _.pegs;
							}(
								_user$project$Utils_ZipperList$current(_p23)));
					}(breakerTries);
					if (_p24 === false) {
						return _elm_lang$core$Native_Utils.update(
							breakerTry_,
				...
				var breakerTries_ = A2(_user$project$Utils_ZipperList$update, newBreakerTry_, breakerTries);
				var newBreakerTries = function () {
					var _p25 = _user$project$Utils_ZipperList$hasNext(newBreakerTry_.pegs);
					if (_p25 === true) {
						var nTry = _elm_lang$core$Native_Utils.update(
							newBreakerTry_,
							{
								pegs: function (_p26) {
									return _user$project$Utils_ZipperList$forward(
										function (_) {
											return _.pegs;
										}(
											_user$project$Utils_ZipperList$current(_p26)));
								}(breakerTries_)
							});
						return A2(_user$project$Utils_ZipperList$update, nTry, breakerTries_);
					} else {
						return _user$project$Utils_ZipperList$forward(breakerTries_);
					}
				}();
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							...
							history: A2(_user$project$Utils_ZipperList$add, newBreakerTries, model.history)
						}),
					{ctor: '[]'});
			default:
				var _p28 = _p18._0;
				var func = (_elm_lang$core$Native_Utils.cmp(_p28, 0) > 0) ? _user$project$Utils_ZipperList$forward : _user$project$Utils_ZipperList$back;
				var history = A3(
					_elm_lang$core$List$foldl,
					F2(
						function (_p27, acc) {
					...
					A2(
						_elm_lang$core$List$range,
						0,
						_elm_lang$core$Basics$abs(_p28) - 1));
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							breakerTries: _user$project$Utils_ZipperList$current(history),
							history: history
						}),
					{ctor: '[]'});
		}
...
var _user$project$Main$init = function (flags) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{
			breakerTries: _user$project$Main$initBreakerTries,
			codeToBreak: A2(_elm_lang$core$List$repeat, 4, _user$project$Main$Grey),
			gameState: _user$project$Main$Start,
			randomSeed: _elm_lang$core$Random$initialSeed(flags.initSeed),
			history: A2(
				_user$project$Utils_ZipperList$init,
				_user$project$Main$initBreakerTries,
				{ctor: '[]'})
...
var _user$project$Main$MoveHistory = function (a) {
	return {ctor: 'MoveHistory', _0: a};
};
var _user$project$Main$viewHistoryLine = function (_p29) {
	var _p30 = _p29;
	var _p31 = _p30._1;
	var style_ = _elm_lang$core$Native_Utils.eq(_p31, 0) ? 'selected-history' : '';
	var indicator = _elm_lang$core$Native_Utils.eq(_p31, 0) ? 'fas fa-angle-right' : '';
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(
				_user$project$Main$MoveHistory(_p31)),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(
					A2(_elm_lang$core$Basics_ops['++'], 'link rounded ', style_)),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _user$project$Main$viewHistory = F2(
	function (gameState, history) {
		var histories = function () {
			...
			if (_p32.ctor === 'Start') {
				...
				return A2(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$Main$viewHistoryLine,
						_user$project$Main$toHistoryLines(history)));
			}
		}();
		return _rundis$elm_bootstrap$Bootstrap_Card$view(
			A3(
				...
				{
					ctor: '::',
					_0: _rundis$elm_bootstrap$Bootstrap_Card_Block$custom(histories),
					_1: {ctor: '[]'}
				},
				A3(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Your moves'),
						_1: {ctor: '[]'}
					},
					_rundis$elm_bootstrap$Bootstrap_Card$config(
						{ctor: '[]'}))));
	});
var _user$project$Main$ChooseColor = function (a) {
	return {ctor: 'ChooseColor', _0: a};
};
var _user$project$Main$viewColorButton = F2(
	function (gameState, pegColor) {
		var supAttrs = function () {
			var _p33 = gameState;
			if (_p33.ctor === 'Try') {
				return {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Main$ChooseColor(pegColor)),
					_1: {ctor: '[]'}
				};
			} else {
				return {ctor: '[]'};
		...
		return A2(
				...
				_1: {
					...
					_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
						A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('color-button'),
								_1: {ctor: '[]'}
							},
							supAttrs)),
					_1: {ctor: '[]'}
			...
			{
				ctor: '::',
				_0: _user$project$Main$viewCodePeg(pegColor),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Main$viewColorChooser = function (gameState) {
	return _rundis$elm_bootstrap$Bootstrap_Card$view(
		A3(
			_rundis$elm_bootstrap$Bootstrap_Card$block,
			{ctor: '[]'},
			{
				...
				_0: _rundis$elm_bootstrap$Bootstrap_Card_Block$custom(
					A2(
						...
						A2(
							_elm_lang$core$List$map,
							_user$project$Main$viewColorButton(gameState),
							_user$project$Main$choosableColors))),
				_1: {ctor: '[]'}
			},
			A3(
				_rundis$elm_bootstrap$Bootstrap_Card$headerH5,
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Choose a color'),
					_1: {ctor: '[]'}
				},
				_rundis$elm_bootstrap$Bootstrap_Card$config(
					{ctor: '[]'}))));
...
var _user$project$Main$viewControlPanel = function (gameState) {
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Grid$row,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Main$viewGameStateMessage(gameState),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
			...
			_1: {
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('text-center title'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Mastermind'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Main$viewControlPanel(model.gameState),
							_1: {
								ctor: '::',
								_0: A2(
									_rundis$elm_bootstrap$Bootstrap_Grid$row,
									{ctor: '[]'},
									{
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: A2(_user$project$Main$viewBoard, model.breakerTries, model.codeToBreak),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _user$project$Main$viewColorChooser(model.gameState),
															_1: {
																ctor: '::',
																_0: A2(_user$project$Main$viewHistory, model.gameState, model.history),
																_1: {ctor: '[]'}
															}
														}),
													_1: {
...
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	...
	A2(
		...
		A2(_elm_lang$core$Json_Decode$field, 'initSeed', _elm_lang$core$Json_Decode$int)));

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.PegColor":{"args":[],"tags":{"Red":[],"Purple":[],"Yellow":[],"Orange":[],"Green":[],"Blue":[],"Grey":[]}},"Main.Msg":{"args":[],"tags":{"NewGame":[],"ChooseColor":["Main.PegColor"],"MoveHistory":["Int"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
