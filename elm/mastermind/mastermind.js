...
var _user$project$Main$isEndOfTries = function (breakerTries) {
	return _elm_lang$core$Native_Utils.eq(
		_user$project$Utils_ZipperList$hasNext(breakerTries),
		...
		function (_p8) {
			return _user$project$Utils_ZipperList$hasNext(
				function (_) {
					...
					_user$project$Utils_ZipperList$current(_p8)));
		}(breakerTries),
		false);
};
...
var _user$project$Main$generateCodeToBreak = function (initSeed) {
	return A3(
		...
		F2(
			function (_p10, _p9) {
				var _p11 = _p9;
				var _p12 = A2(_elm_lang$core$Random$step, _user$project$Main$randomColor, _p11._1);
				var res = _p12._0;
				var newSeed = _p12._1;
				return {
					ctor: '_Tuple2',
					_0: {ctor: '::', _0: res, _1: _p11._0},
					_1: newSeed
				};
			}),
		{
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p13.ctor) {
			case 'NewGame':
				var _p14 = _user$project$Main$generateCodeToBreak(model.randomSeed);
				var newCode = _p14._0;
				var newSeed = _p14._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'ChooseColor':
						...
						function (_p16) {
							return _user$project$Utils_ZipperList$hasNext(
								function (_) {
									...
									_user$project$Utils_ZipperList$current(_p16)));
						}(breakerTries),
						false);
					if (_p17 === true) {
						...
						function (_p18) {
							return _user$project$Utils_ZipperList$hasNext(
								function (_) {
									...
									_user$project$Utils_ZipperList$current(_p18)));
						}(breakerTries),
						false) && _elm_lang$core$Native_Utils.eq(
						A2(
				...
				var newBreakerTry_ = function () {
					var _p21 = function (_p20) {
						return _user$project$Utils_ZipperList$hasNext(
							function (_) {
								return _.pegs;
							}(
								_user$project$Utils_ZipperList$current(_p20)));
					}(breakerTries);
					if (_p21 === false) {
						return _elm_lang$core$Native_Utils.update(
							breakerTry_,
				...
				var newBreakerTries = function () {
					var _p22 = _user$project$Utils_ZipperList$hasNext(newBreakerTry_.pegs);
					if (_p22 === true) {
			...
			default:
				var _p25 = _p13._0;
				var func = (_elm_lang$core$Native_Utils.cmp(_p25, 0) > 0) ? _user$project$Utils_ZipperList$forward : _user$project$Utils_ZipperList$back;
				var history = A3(
					_elm_lang$core$List$foldl,
					F2(
						function (_p24, acc) {
					...
					A2(
						_elm_lang$core$List$range,
						0,
						_elm_lang$core$Basics$abs(_p25) - 1));
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$Main$viewHistoryLine = function (_p26) {
	var _p27 = _p26;
	var _p28 = _p27._1;
	var style_ = _elm_lang$core$Native_Utils.eq(_p28, 0) ? 'selected-history' : '';
	var indicator = _elm_lang$core$Native_Utils.eq(_p28, 0) ? 'fas fa-angle-right' : '';
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(
				_user$project$Main$MoveHistory(_p28)),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(
...
var _user$project$Main$viewHistory = F2(
	function (gameState, history) {
		var historyLines = function () {
			var _p29 = _user$project$Main$toDisplayableHistories(history);
			if (_p29.ctor === '[]') {
				return {ctor: '[]'};
			} else {
				if (_p29._1.ctor === '[]') {
					return {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'Start', _1: _p29._0._1},
						_1: {ctor: '[]'}
					};
				} else {
					if ((_p29._1._0.ctor === '_Tuple2') && (_p29._1._1.ctor === '[]')) {
						return {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'Start', _1: _p29._0._1},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'Resume', _1: _p29._1._0._1},
								_1: {ctor: '[]'}
							}
						};
					} else {
						var _p34 = _p29._1;
						var rest_ = function () {
							var _p30 = _elm_lang$core$List$reverse(_p34);
							if (_p30.ctor === '::') {
								return _elm_lang$core$List$reverse(_p30._1);
							} else {
								return {ctor: '[]'};
							}
						}();
						var mid = A3(
							...
							rest_);
						var end = function () {
							var _p33 = _elm_lang$core$List$reverse(_p34);
							if (_p33.ctor === '::') {
								return {ctor: '_Tuple2', _0: 'Resume', _1: _p33._0._1};
							} else {
								return {ctor: '_Tuple2', _0: 'Resume', _1: 0};
							}
						}();
						var start = {ctor: '_Tuple2', _0: 'Start', _1: _p29._0._1};
						return {
							ctor: '::',
							_0: start,
							_1: A2(
		...
		var histories = function () {
			...
			if (_p35.ctor === 'Start') {
				...
				return A2(
					_elm_lang$html$Html$div,
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$Main$viewHistoryLine, historyLines));
			}
		}();
